...
<html lang = "eng">
	<head>
		<title>Minegaraha High School</title>
		<meta charset = "utf-8" />
	...
	<body>
		<nav class = "navbar navbar-inverse navbar-fixed-top" style="background-color: green; color: white;" >
			<div class = "container-fluid">
				<div class = "navbar-header">
					...
					<p class = "navbar-text pull-right" style="color: white;">Minegaraha High School</p>
				</div>
		...
		<div class = "container-fluid" style = "margin-top:70px;">
			...
			<div class = "well col-lg-12">
				<img src = "images/high_school_campus.png"  width = "1255px" height = "370px" />
			<br />
			<br />	
			<br />	
			</div>
